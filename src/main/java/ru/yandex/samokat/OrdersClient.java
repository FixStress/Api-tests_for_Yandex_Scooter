...
public class OrdersClient extends RestClient {
    ...
    public Response acceptOrderWithoutIdOrder(int idCourier) {
        ...
        /* Не уверен насчёт правильности, но вычитал, что нельзя отправлять URL с query параметрами в виде
        https://qa-scooter.praktikum-services.ru/api/v1/orders/accept/?courierId=285175 и
        в виде https://qa-scooter.praktikum-services.ru/api/v1/orders/accept/courierId=285175
        поэтому переделал на https://qa-scooter.praktikum-services.ru/api/v1/orders/accept?courierId=285175*/
        return given()
                .spec(getSpecWithoutContentType())
                .queryParam("courierId", idCourier)
                .put(endpoint);
